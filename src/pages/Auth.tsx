...
import { ArrowLeftRight, Mail, Lock, User } from "lucide-react";
            ...
            {isSignUp && (
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Input id="name" placeholder="Your name" value={fullName} onChange={(e) => setFullName(e.target.value)} className="pl-9" required />
                </div>
              </div>
            )}
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <Input id="email" type="email" placeholder="you@university.edu" value={email} onChange={(e) => setEmail(e.target.value)} className="pl-9" required />
              </div>
            </div>
            <div className="space-y-1.5">
